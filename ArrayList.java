            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    if (index1 >= 0 && index1 < list.size()) {
                        System.out.println("Value at index " + index1 + " is " + list.get(index1));
                    } else {
                ...
                case 3:
                    ...
                    if (index2 >= 0 && index2 < list.size()) {
                        System.out.println(list.remove(index2) + " is removed from index " + index2);
                    } else {
                        System.out.println("Invalid index!");
                    }
                    break;
                ...
                case 7:
                    ...
                    if (index >= 0 && index <= list.size()) {
                        ...
                        int num = sc.nextInt();
                        list.add(index, num);//add - just adds the element even if any element is present in the index
                                            //set - replaces the element if any element is in the specified index
                        System.out.println(num + " is inserted at index " + index);
                    } else {
                        System.out.println("Invalid index!");
                    }
                    break;
